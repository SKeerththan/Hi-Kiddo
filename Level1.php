...
<body style="background-color:#E6E6FA;">
    ...
    if (!isset($_SESSION['kidIndex'])) {
        ...
        $row = mysqli_fetch_assoc($sql); // Use mysqli_fetch_assoc to fetch the row data
        $con->close();
        ...
        if ($levelOneCount >= 10) {
            ...
            echo "Swal.fire({
                    ...
                    imageHeight: 200,
                    imageAlt: 'Custom image',
                    }).then(() => { window.location.href='Level2.php'; });";
            echo "</script>";
        }
    }
    ...
    <form action="Level1.php" name="formCheck" id="formCheck" method="POST" onsubmit=" ">
        ...
        <div class="buttons">
            ...
            <label class="btn rank"><?php echo  1 + $levelOneCount . "/10"; ?></label>
