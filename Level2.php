...
<body style="background-color:#FFE4E1;">
    ...
    if (!session_start()) {
        ...
        if ($levelTwoCount >= 10) {
            ...
            echo "Swal.fire({
                    ...
                    imageHeight: 200,
                    imageAlt: 'Custom image',
                    }).then(() => { window.location.href='Level3.php'; });";
            echo "</script>";
        }
    }
    ...
    ?>
    <form action="Level2.php" name="formCheck" id="formCheck" method="POST" onsubmit=" ">
        ...
        <div>
            <div class="buttons">
                ...
                <label class="btn rank"><?php echo 1 + $levelTwoCount . "/10"; ?></label>
