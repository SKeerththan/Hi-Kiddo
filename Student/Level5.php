    ...
    <form action="Level5.php" id="" method="POST">
        ...
        <div id="loadQuestions">
            <div class="row">
                ...
                <div class="col">
                    <img src="Images/Sign/mu.png" alt="" style="height: 100px;">
    ...
    <script>
        ...
        function check() {
            if ((document.getElementById('a0').checked) && document.getElementById('a0').value == correctAnswer) {
                ...
                swal("That is not a suitable answer, Correct answer : " + numberOne + "x" + numberTwo + "=" + correctAnswer, "Give another try", "error");
            }
        }
        setTimeout(() => {
            speakMe();
