...
<body style="background-color:#D8BFD8;">
    ...
    if (!session_start()) {
        ...
        if ($levelSixCount >= 10) {
            ...
            echo "Swal.fire({
                    ...
                    imageHeight: 200,
                    imageAlt: 'Custom image',
                    }).then(() => { window.location.href='Play.php'; });";
            echo "</script>";
        }
    }
    ...
    <form action="Level6.php" name="formCheck" id="formCheck" method="POST" onsubmit=" ">
        ...
        <div class="buttons">
            ...
            <label class="btn rank"><?php echo 1 + $levelSixCount . "/10"; ?></label>
