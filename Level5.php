...
<body style="background-color:#F5F5DC;">
    ...
    if (!session_start()) {
        ...
        if ($levelFiveCount >= 10) {
            ...
            echo "Swal.fire({
                    ...
                    imageHeight: 200,
                    imageAlt: 'Custom image',
                    }).then(() => { window.location.href='Level6.php'; });";
            echo "</script>";
        }
    }
    ...
    ?>
    <div class="cards">
        <form action="Level5.php" name="formCheck" id="formCheck" method="POST" onsubmit=" ">
            ...
            <div class="buttons">
                ...
                <label class="btn rank"><?php echo 1 + $levelFiveCount . "/10"; ?></label>
