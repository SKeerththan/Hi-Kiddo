...
<body style="background-color:#D8A7B1;">
    ...
    if (!session_start()) {
        ...
        if ($levelFourCount >= 10) {
            ...
            echo "Swal.fire({
                    ...
                    imageHeight: 200,
                    imageAlt: 'Custom image',
                    }).then(() => { window.location.href='Level5.php'; });";
            echo "</script>";
        }
    }
    ...
    ?>
    <form action="Level4.php" name="formCheck" id="formCheck" method="POST" onsubmit=" ">
        ...
        <div class="buttons">
            ...
            <label class="btn rank"><?php echo 1 + $levelFourCount . "/10"; ?></label>
